package com.example.muslimwork.video_kajian.data
...
object VideoKajianData {
    private val thumbnailVideo = intArrayOf(
        R.drawable.thumbnail_kajian_1,
        R.drawable.thumbnail_kajian_2,
        R.drawable.thumbnail_kajian_3,
        R.drawable.thumbnail_kajian_4,
        R.drawable.thumbnail_kajian_5
    )
